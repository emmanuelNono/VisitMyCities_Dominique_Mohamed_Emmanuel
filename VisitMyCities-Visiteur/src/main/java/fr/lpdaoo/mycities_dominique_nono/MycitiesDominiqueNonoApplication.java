...
import fr.lpdaoo.mycities_dominique_nono.dao.VilleDAO;
import fr.lpdaoo.mycities_dominique_nono.dao.VisiteurDAO;
...
public class MycitiesDominiqueNonoApplication implements CommandLineRunner {
	...
	@Autowired private VisiteurDAO visiteurDAO;
	@Autowired private VilleDAO villeDAO;
